...
videoPath = 'C:\Users\Vero\Videos\';%'C:\Users\Vero\Documents\Videos\Experiments\';
param.arenaThreshold=130;

Filenames={...
    '0004C01R01Cam03P0WT-CantonS.avi';...
'0004C01R01Cam04P0WT-CantonS.avi';...
'0004C02R01Cam01P0WT-CantonS.avi';...
    };
...
%             end
    ...
    atoc=toc
    save(['C:\Users\Vero\Bonsai tracking\TrackingBonsaiParams-' filename(1:end-4) '-Left.mat'],'FlytracksNewL','atoc','param','filename')
    save(['C:\Users\Vero\Bonsai tracking\TrackingBonsaiParams-' filename(1:end-4) '-Centre.mat'],'FlytracksNewC','atoc','param','filename')
    save(['C:\Users\Vero\Bonsai tracking\TrackingBonsaiParams-' filename(1:end-4) '-Right.mat'],'FlytracksNewR','atoc','param','filename')
