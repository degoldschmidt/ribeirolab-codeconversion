...
param.arenaThreshold=140;

Filenames={...
'0011A04R04Cam01P0CantonSTbH.avi';...
'0011A04R04Cam02P0CantonSTbH.avi';...
'0011A05R02Cam01P0CantonSTbH.avi';...
'0011A05R02Cam02P0CantonSTbH.avi';...
'0011A05R03Cam01P0CantonSTbH.avi';...
'0011A05R03Cam02P0CantonSTbH.avi';...
'0011A05R04Cam01P0CantonSTbH.avi';...
'0011A05R04Cam02P0CantonSTbH.avi';...
'0011A06R03Cam01P0CantonSTbH.avi';...
'0011A06R03Cam02P0CantonSTbH.avi';...
'0011A06R04Cam01P0CantonSTbH.avi';...
'0011A06R04Cam02P0CantonSTbH.avi';...
};
...
%                 % else of the Arees0 condition
            ...
            %% Savi';...ng all parameters in separate cells for each arena %%
            ...
            %% Savi';...ng Backup at 10000 frames %%
...
%             end
    ...
    toc;
    atoc=toc
    save(['C:\Users\Vero\Bonsai tracking\Exp 11\TrackingBonsaiParams-' filename(1:end-4) '-Left.mat'],'FlytracksNewL','atoc','param','filename')
    save(['C:\Users\Vero\Bonsai tracking\Exp 11\TrackingBonsaiParams-' filename(1:end-4) '-Centre.mat'],'FlytracksNewC','atoc','param','filename')
    save(['C:\Users\Vero\Bonsai tracking\Exp 11\TrackingBonsaiParams-' filename(1:end-4) '-Right.mat'],'FlytracksNewR','atoc','param','filename')
