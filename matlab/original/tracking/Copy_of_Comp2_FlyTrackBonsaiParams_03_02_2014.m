...
videoPath = 'C:\Users\Public\Videos\Recordings Fly Tracker Prject\Exp 4\';%
param.arenaThreshold=130;

Filenames={...
'0004B03R01Cam03P0WT-CantonS.avi';...
'0004B03R01Cam04P0WT-CantonS.avi';...
'0004B03R02Cam03P0WT-CantonS.avi';...
};
...
%             end
    ...
    toc;
    atoc=toc
    save(['C:\Users\Vero\Bonsai tracking\Exp 4\TrackingBonsaiParams-' filename(1:end-4) '-Left.mat'],'FlytracksNewL','atoc','param','filename')
    save(['C:\Users\Vero\Bonsai tracking\Exp 4\TrackingBonsaiParams-' filename(1:end-4) '-Centre.mat'],'FlytracksNewC','atoc','param','filename')
    save(['C:\Users\Vero\Bonsai tracking\Exp 4\TrackingBonsaiParams-' filename(1:end-4) '-Right.mat'],'FlytracksNewR','atoc','param','filename')
