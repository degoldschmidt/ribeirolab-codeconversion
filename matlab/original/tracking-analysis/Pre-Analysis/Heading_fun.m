...
% Exp_num='0003';
% Exp_letter='A';
% TrackDataDir_Bonsai=['C:\Users\Vero\Bonsai tracking\Exp ' Exp_num '\'];%['C:\Users\Vero\Bonsai tracking\Experiment ' Exp_num '\'];;
% Vid_info_dir='C:\Users\Vero\Dropbox (Behavior&Metabolism)\Personal\Experiments Videos Info.xlsx';%
% videoPath = ['C:\Users\Public\Videos\Recordings Fly Tracker Prject\Exp ' Exp_num '\'];%
% DataSaving_dir_temp='C:\Users\Vero\Bonsai tracking\Exp ';
% Heads_SteplengthDir=[DataSaving_dir_temp Exp_num '\Heads_Steplength\'];%'C:\Users\Vero\Documents\Analysis Data\Experiment 9\Heads_Steplength\';

% from=128;until=151;% EXP 9A%from=198;until=227;%EXP4Afrom=80;until=127;%EXP3A  from=368;until=391;%EXP8A
...
if ~((sum(Exp_num=='0003')==4)&&(Exp_letter=='A'))%if not 8B
    ...
    save([DataSaving_dir_temp Exp_num '\Variables\FirstHeads&Tails' Exp_num Exp_letter '.mat'],'FirstHead','FirstTail')
else
    %% Loading First-Head and -Tail struct for EXP 4
...
%     load(['C:\Users\Vero\Documents\Analysis Data\Experiment 0012\Variables\FirstHeads&Tails',...
%         Exp_num Exp_letter '.mat'],'FirstHead','FirstTail')
    load([DataSaving_dir_temp Exp_num '\Variables\FirstHeads&Tails' Exp_num Exp_letter '.mat'],'FirstHead','FirstTail')
end
...
typeofheads='Heads';
Steplength_Jumps
display('Calculation of heads has finished')
%% Quality control
% Largejump_thr=40;
ForwardWalkThresh=40;%px
