%% Initial parameters
lsubs=1;
Conditions=[4 1];%[2 1 3 4];%EXP 8B [6 4 5 1 3];%Exp 3D
...
for lcond=Conditions
    lcondcounter=lcondcounter+1;
    figure('Position',[50 50 800 800],'Color',[240 240 240]/255,'PaperUnits','centimeters',...'w'
...
set(gca,'Position',[x y widthsubplot heightsubplot])
    ...
    set(gca,'Color',[240 240 240]/255,'YColor',[240 240 240]/255)
...
% plot((1:maxframe)/params.framerate/60,...
%     nanmedian(cumsum(CumTimeH{lsubs}(1:maxframe,params.ConditionIndex==lcond)),2)/50/60,...
%     '-k','Color',ColorsinPaper(lcond==Conditions,:),'LineWidth',1);
% % plot(maxframe/params.framerate/60,...
