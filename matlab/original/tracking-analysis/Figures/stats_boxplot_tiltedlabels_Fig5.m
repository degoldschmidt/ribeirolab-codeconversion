function stats_boxplot_tiltedlabels_Fig5(X,variable_labels,MergedConditions,xvalues,plot_type,lsubs,params,...
    ...
    for lcompar1=1:length(MergedConditions)-1
        for lcompar2=lcompar1+1:length(MergedConditions)
            ...
            elseif strfind([Exp_num,Exp_letter],'0011A')
                 if (lcompar2==lcompar1+1)&&~(lcompar1==2&&lcompar2==3)
